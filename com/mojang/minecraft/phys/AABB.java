...
public class AABB
{
  ...
  public float y1;
  public float z1;
  public AABB expand(float xa, float ya, float za) { float _x0 = x0;
    float _y0 = y0;
    float _z0 = z0;
    float _x1 = x1;
    float _y1 = y1;
  ...
  {
    if ((y1 <= y0) || (y0 >= y1)) return xa;
    if ((z1 <= z0) || (z0 >= z1)) { return xa;
    }
    if ((xa > 0.0F) && (x1 <= x0))
    {
  ...
  {
    if ((x1 <= x0) || (x0 >= x1)) return ya;
    if ((z1 <= z0) || (z0 >= z1)) { return ya;
    }
    if ((ya > 0.0F) && (y1 <= y0))
    {
  ...
  {
    if ((x1 <= x0) || (x0 >= x1)) return za;
    if ((y1 <= y0) || (y0 >= y1)) { return za;
    }
    if ((za > 0.0F) && (z1 <= z0))
    {
  ...
  {
    if ((x1 <= x0) || (x0 >= x1)) return false;
    if ((y1 <= y0) || (y0 >= y1)) return false;
    if ((z1 <= z0) || (z0 >= z1)) return false;
    return true;
  }
