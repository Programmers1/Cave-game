...
public class ZombieModel {
  ...
  public Cube leg0;
  public Cube leg1;
  public void render(float time) { head.yRot = ((float)Math.sin(time * 0.83D) * 1.0F);
    head.xRot = ((float)Math.sin(time) * 0.8F);
    
    arm0.xRot = ((float)Math.sin(time * 0.6662D + 3.141592653589793D) * 2.0F);
    ...
    leg1.xRot = ((float)Math.sin(time * 0.6662D + 3.141592653589793D) * 1.4F);
